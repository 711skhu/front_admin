...
<script>
  import LectureInfoView from "@/admin/components/lecture/LectureInfoView";
  ...
  let items = [
    new LectureCategoryItem('제출된 문제', 4),
    new LectureCategoryItem('미제출 문제', 3),
...
<style scoped>
  ...
  .category-panel__item:last-child {
    margin-right: 0;
  }
</style>
